...
class SNNAE(nn.Module):
    ...
    def __init__( self, input_dim=None, beta=0.5, thresh=1.0, num_steps=5, layers=[128,64], latent_dim=5, hidden_dim=128, lr=0.001 ):
        super().__init__()
        ...
        self.encoder_layer_dims = layers
        self.decoder_layer_dims = layers
...
class AE(nn.Module):
    ...
    def __init__( self, input_dim=None, layers=[128,64], latent_dim=5, hidden_dim=128, lr=0.001 ):
        super().__init__()
        # network params
        self.input_dim = input_dim
        self.encoder_layer_dims = layers
